...
from homeassistant.helpers.config_entry_oauth2_flow import AbstractOAuth2FlowHandler, LocalOAuth2Implementation
...
SMARTTHINGS_REDIRECT_URI = "https://multiply-leading-albacore.ngrok-free.app/auth/external/callback"
...
class SmartThingsOAuth2Implementation(LocalOAuth2Implementation):
    ...
    def redirect_uri(self) -> str:
        ...
        return SMARTTHINGS_REDIRECT_URI
