...
#MY_AUTH_CALLBACK_PATH = "https://cosmic-hare-forcibly.ngrok-free.app/auth/external/callback"
MY_AUTH_CALLBACK_PATH = "https://multiply-leading-albacore.ngrok-free.app/auth/external/callback"
...
def async_get_redirect_uri(hass: HomeAssistant) -> str:
    ...
    # print("Umaid Final Using my home assistant redirect uri")
...
class LocalOAuth2Implementation(AbstractOAuth2Implementation):
    ...
    def redirect_uri(self) -> str:
        """Return the redirect uri."""
        print("Umaid Using my home assistant redirect uri Hello", async_get_redirect_uri(self.hass))
